    ...
    var hourChart = dc.pieChart("#hour-chart");
    ...
    d3.csv("./static/files/Workbook2.csv", function(error, csv) {
        ...
        var ethnicityCount = ethnicities.group().reduceSum(function(d) {
            return d.count;
        });

        var entryStatuses = data.dimension(function(d) {
        ...
        var entryStatusCount = entryStatuses.group().reduceSum(function(d) {
            return d.count;
        });
        var gradStatuses = data.dimension(function(d) {
            return d.undergradStatus;
        });
        var gradStatusCount = gradStatuses.group().reduceSum(function(d) {
            return d.count;
        });
        ...
        var genderCount = genders.group().reduceSum(function(d) {
            return d.count;
        });
        ...
        var hourCount = hours.group().reduceSum(function(d) {
            return d.count;
        });

        var censusYears = data.dimension(function(d) {
            return d.censusYear;
        });
        var censusYearCount = censusYears.group().reduceSum(function(d) {
            return d.count;
        });

        var ethnicitiesByYear = data.dimension(function(d) {
            return [d.raceEthnicity, d.censusYear];
        });
        var ethnicitiesByYearCount = ethnicitiesByYear.group().reduceSum(function(d) {
            return d.count;
        });
        ...
        var pieTip = d3.tip()
            ...
            .offset([-10, 0])
            .html(function(d) {
                return "<span style='color: #f0027f'>" + d.data.key + "</span> : " + numFormat(d.value);
            });
        ...
        var barTip = d3.tip()
            ...
            .offset([-10, 0])
            .html(function(d) {
                return "<span style='color: #c6dbef'>" + d.key + "</span> : " + numFormat(d.value);
            });
        ...
        var seriesTip = d3.tip()
            ...
            .offset([-10, 0])
            .html(function(d) {
                return "<span style='color: #c6dbef'>" + d.data.key[0] + " (" + parseDate(d.data.key[1]) + ")" + "</span> : " + numFormat(d.data.value);
            });
        ...
        var areaTip = d3.tip()
            ...
            .offset([-10, 0])
            .html(function(d) {
                return "<span style='color: #c6dbef'>" + parseDate(d.data.key) + "</span> : " + numFormat(d.data.value);
            });
        ...
        yearChart.width(0)
            ...
            .renderArea(true)
            .title(function(d) {
                return d.key[0] + " (" + parseDate(d.key[1]) + ") " + numFormat(d.value);
            })
            .title(function() {
                return "";
            })
